% ========== 基础包 ==========
\usepackage[UTF8,fontset=fandol]{ctex}% 中文支持；使用 TeX Live 自带字体，避免依赖系统 STHeiti
...
\usepackage{float}                    % 提供 [H] 选项，强制图片就地放置
\usepackage{subcaption}               % subcaption / subfigure（multi-panel 图）
\usepackage{adjustbox}                % 图表最大宽度自适应，避免流程图超页
...
\fancyhead[R]{\small\textcolor{textgray}{WangYe 的学习笔记}}
